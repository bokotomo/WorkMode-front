...
import { requestTaskCreate, requestTaskUpdateStatus, requestTaskDelete } from '../controller/task'
...
export const deleteTask = (dispatch: Dispatch, socket: WebSocket, taskId: string) => {
    const token = new Cookies().get('token') || ''
